...
PROFILES: dict[str, dict[str, dict[str, Any]]] = {
    "standalone": {
        "simplicio-loop": {"min_version": "3.38.5", "required": True,
                            "capabilities": ("plan", "orient", "run")},
        "simplicio-mapper": {"min_version": "0.19.0", "required": True,
                              "capabilities": ("orient", "recall")},
        "simplicio-dev-cli": {"min_version": "0.11.0", "required": True,
                               "capabilities": ("execute", "validate")},
        "simplicio-fast": {"min_version": "2.0.14", "required": False,
    ...
    "full-stack": {
        ...
        "simplicio-dev-cli": {"min_version": "0.11.0", "required": True,
                               "capabilities": ("execute", "validate")},
        "simplicio-fast": {"min_version": "2.0.14", "required": True,
