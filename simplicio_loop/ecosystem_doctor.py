...
PROFILES: dict[str, dict[str, dict[str, Any]]] = {
    "standalone": {
        ...
        "simplicio-mapper": {"min_version": "0.26.0", "required": True,
                              "capabilities": ("orient", "recall")},
        "simplicio-dev-cli": {"min_version": "0.18.0", "required": True,
                               "capabilities": ("execute", "validate")},
        "simplicio-fast": {"min_version": "2.0.16", "required": False,
    ...
    "full-stack": {
        ...
        "simplicio-dev-cli": {"min_version": "0.18.0", "required": True,
                               "capabilities": ("execute", "validate")},
        "simplicio-fast": {"min_version": "2.0.16", "required": True,
