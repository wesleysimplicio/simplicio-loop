...
| 11 | 🎬 **video_evidence (hyperframes)** | [hyperframes](https://github.com/heygen-com/hyperframes) | تُصيِّر **فيديو MP4 حتميّاً** يعرض شاشة/ميزة — يُلبّي `/simplicio-tasks make a demo video of screen X` ويصلح أيضاً برهاناً قابلاً لإعادة الإنتاج في الـ CI على أن تغييراً في الواجهة يعمل | منتج الأدلة |
