...
चलाने-योग्य और परीक्षित** है (`python3 scripts/check.py`: claims-audit 4/4 + 27 tests)। प्रत्येक अपने
गहन खंड और अपने वर्कर से जुड़ती है।

| क्षमता | यह क्या करती है | प्रमाण / वर्कर | विवरण |
|---|---|---|---|
| 🎬 **Video evidence** (`video_evidence`) | किसी स्क्रीन/फ़ीचर का **नियतात्मक MP4** डेमो [hyperframes](https://github.com/heygen-com/hyperframes) के साथ रेंडर करती है — `/simplicio-tasks make a demo video of screen X` को पूरा करती है और किसी UI परिवर्तन के काम करने के CI-पुनरुत्पादनीय प्रमाण के रूप में भी कार्य करती है | `scripts/video_evidence.py` · Node 22+/FFmpeg के बिना BLOCKED (कभी fake-pass नहीं) | [§ Video evidence](#-video-evidence--hyperframes-के-माध्यम-से-डेमो-वीडियो) |
...
| 11 | 🎬 **video_evidence (hyperframes)** | [hyperframes](https://github.com/heygen-com/hyperframes) | किसी स्क्रीन/फ़ीचर का **नियतात्मक MP4** डेमो वीडियो रेंडर करता है — `/simplicio-tasks make a demo video of screen X` को पूरा करता है और किसी UI परिवर्तन के काम करने के CI-पुनरुत्पादनीय प्रमाण के रूप में भी कार्य करता है | साक्ष्य उत्पादक |
